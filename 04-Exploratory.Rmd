...
Therefore, we start with examining the trends of the two main variables, **HighSchool_PR** and **College_Score**. We look at each variable separately (univariate analysis), then investigate the relationship between the two variables (bivariate exploration).
