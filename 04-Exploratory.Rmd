...
The third row contains graphs that visualize a medium level of linear correlation, where $0.4 < |\rho| < 0.6$.   

\textcolor{red}{Elaborate on the foreword}     

- The left figure shows $\rho = 0.64$.     
...
- The right figure shows $\rho = -0.47$.     
