...
Sensitivity analysis: Look at the univariate distribution with vs without the missing values!   

Basically need to explain why we used the full univariate set available, instead of just taking those with a valid second score.  
...
\textcolor{red}{Also talk about the median PR as 92 and compare to high school entrance score requirements.}     

\textcolor{red}{Why median > mean in this situation? Compared with most right-skewed distributions, where median < mean.}   
