...
The function `runif` in the `stats` package generates samples from the **continuous** uniform distribution.   

But we need the **discrete** uniform distribution.   
...
\textcolor{red}{Also plot the histogram of the random sample}   
