...
The final row shows what little-to-no linear correlation looks like.   

\textcolor{red}{Zero correlation does not mean the two variables are independent. They may have a non-linear relationship, which cannot be detected by the correlation coefficient.}     

For a small $\rho$ in absolute value, the two variables barely have any linear relationship. Even when the bivariate scatter plot looks random, the correlation coefficient may not be exactly zero.    
