...
```{r draft-comments, include=FALSE}
...
```{r draft-correlation-comments, include=FALSE}
...
\textcolor{red}{Need to adjust the size of each plot to make the data trends more visible.}      

At the final step, consider hiding the numbers in x-axis and y-axis to make the graph look cleaner.   


Should I hide the code and function to avoid obscuring the focus of correlation coefficient?  

```{r draft-correlation}

# UNFINISHED HERE
# Experiment and add more graphs
