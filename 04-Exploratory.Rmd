...
The third set of graphs in Figure \ref{fig:mid-correlation} visualizes a medium level of linear correlation, where $0.4 < |\rho| < 0.6$. The linear trend is still visible, but with more fluctuation than in the high-correlation graphs.    
