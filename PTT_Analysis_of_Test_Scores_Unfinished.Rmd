...
Again, the logistic regression model assumes all else are held equal.  
...
Impractical to find similarly situated people, but we need to define what is "similarly situated".
