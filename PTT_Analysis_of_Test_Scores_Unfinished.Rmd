...
\textcolor{red}{Need to describe the definitions}   
...
\textcolor{red}{Elaborate on the description}  
...
Specificity means when a patient does not have the disease (actual negative), the medical test is able to produce a negative result. That is, the medical test is specific enough that it filters out patients who do not have the disease.  
