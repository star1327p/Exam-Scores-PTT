...
\textcolor{red}{Predictive modeling, contingency table, etc.}  

Contingency table  

Prediction: If predicted probability of **College_Score** at least 65 is greater than or equal to 0.5, we assign the predicted value as `TRUE`.  
