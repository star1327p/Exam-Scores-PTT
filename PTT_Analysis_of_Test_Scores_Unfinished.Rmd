...
plot(data_corr$HighSchool_PR, data_corr$College_Score,
     main = "High School and College Entrance Exam Scores",
     xlab="High School Entrance Exam Score Percentile Rank (PR)",
     ylab="College Entrance Exam Score")
...
```{r validation-draft}
# Draft of graph
# Add jittering? Too many repetitive values in HighSchool_PR!
yy = model$fitted.values
xx = data_corr$HighSchool_PR
plot(xx, yy, main="Predicted Probability of College Score >= 65 with High School PR",
     xlab="High School Entrance Exam Score Percentile Rank (PR)",
     ylab="Probability of College Score >= 65")
```
...
new_yy = jitter(yy)
plot(new_xx, new_yy, 
     main="Jittered Probability of College Score >= 65 with High School PR",
     xlab="High School Entrance Exam Score Percentile Rank (PR)",
     ylab="Probability of College Score >= 65")
```
