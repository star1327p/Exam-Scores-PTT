...
The foreword starts here.  

Section \ref{learning-statistics} points to some resources for learning statistics, while Section \ref{learning-data-science} takes a step forward to data science and programming.  
