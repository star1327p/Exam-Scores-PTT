---
title: Statistical Analysis of High School and College Entrance Exam Scores in Taiwan
  with Online Data
author:
- Christine P. Chai
- cpchai21@gmail.com
...
1. Add captions for all figures, starting from Section \ref{logit-overall-graphs}.  

2. Change the size of each figure when necessary. Some figures are too large and take up too much space.

I may not need to add more references until I fix the two issues above. Then I can ask some friends (preferably current high school teachers) to verify the correctness of the high school and college entrance rules in Taiwan.  
