...
\subsubsection{Model Validation: Contingency Table}

\section*{\textcolor{red}{Unfinished below}}


Let's start the model validation with in-sample prediction; that is, predict the outcome of whether **College_Score** is at least 65 for each value of **HighSchool_PR** in the data. If predicted probability of **College_Score** at least 65 (i.e., `fitted.values`) is greater than or equal to 0.5, we assign the predicted value as `TRUE`.  
...
Need to say the actual data's proportions.
