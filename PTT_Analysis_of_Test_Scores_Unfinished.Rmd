...
**HighSchool_PR** 90-94 is the most interesting group, because it is the only category where the model predicts both TRUE and FALSE values. 

Although the accuracy is less than 50%, the recall is impressively high (over 80%). The model predicted 37 out of 44 students in this category to achieve **College_Score** 65 or higher, but 22 of them did not make it.   
