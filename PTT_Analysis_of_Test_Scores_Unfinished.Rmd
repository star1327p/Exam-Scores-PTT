...
With p-value < 0.05, we can make the conclusion now?!  

Just like an at-home Covid test, we conclude the test is positive upon seeing two lines.  

\textcolor{red}{But we should still try to understand the rationale behind the chisq.test function.}  
