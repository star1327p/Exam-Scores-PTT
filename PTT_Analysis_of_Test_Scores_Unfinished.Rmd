...
Another common implementation is the **leave-one-out cross validation**, in which each record is considered an independent subset. This is essentially setting $K$ to be the number of total records in the data, say $N$.    

Continue writing here  

Why is leave-one-out cross validation better?  
