...
The precision is N/A due to division-by-zero for the **HighSchool_PR** 0-79 and 80-89 categories. The model predicted all students in the two categories not to achieve **College_Score** 65 or higher, i.e., zero positive predictions. Note that these students had a non-zero probability to obtain this achievement, but their predicted probability is less than the threshold of 50\%, and that's why the datapoints are predicted as negative. 
