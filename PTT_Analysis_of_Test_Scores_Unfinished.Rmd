...
Also, add labels to **every** section (subsections are not required).
...
e.g. Problem formulation (into a binary prediction task)  

e.g. In-sample prediction vs out-of-sample prediction  
...
Our original problem is to find the relationship between high school entrance exam scores and college entrance exam scores.  
