...
```{r include-out-sample-00, child = '09-Out-Sample-01-Sep-Explain.Rmd'}
```

### Implementation {#train-test-demo}

```{r include-out-sample-00, child = '09-Out-Sample-02-Sep-Implement.Rmd'}
```
...
\begin{table}[ht]
    ...
    Separate Training \& Testing   & 71.28\%  & 69.64\%   & 76.59\% & 34.30\% & 23.41\% \\ \hline
    K-Fold Cross Validation        & 71.60\%  & 68.32\%   & 78.26\% & 34.79\% & 21.74\% \\ \hline
