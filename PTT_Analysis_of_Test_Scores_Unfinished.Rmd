...
Add a scatterplot for **HighSchool_PR** at least 80 vs **College_Score** at least 60.  
...
\textcolor{red}{Add a graph of where my scores stand in the scatterplot. Also add the predictions of PR95 for getting College Score 65 or higher.}   

Copied the graph from Section \ref{bivariate}  

The red dot in the top-right indicates where the author's high school and college entrance exam scores stand.  
...
# UNFINISHED HERE
# Add the datapoint of (HighSchool_PR = 95, College_Score = 69)
# Should I add a graph for top-scorers as a zoom-in?
```

Check all **College_Score** datapoints for **HighSchool_PR** 95  
