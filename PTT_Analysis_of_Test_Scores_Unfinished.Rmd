...
What about the breakdown by high school entrance exam score category?  

Why are we interested in this part? Add link to the relevant sections.  

Exploratory data analysis shows the data are left-skewed, i.e., much more respondents with high scores than low scores.  

After linear regression, Chapter \ref{explore-top} is a deeper dive ??  

Then after logistic regression, Section \ref{another-breakdown} also examines the model results by high school entrance exam score category ??  
