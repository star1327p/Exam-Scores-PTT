...
In mathematical terms, the correlation coefficient between the random variables $X, Y$ is calculated by the equation below. $E[X]$ denotes the expectation value of $X$, a.k.a. the mean of $X$.
