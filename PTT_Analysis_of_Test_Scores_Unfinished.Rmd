...
In this project, we analyze the relationship between high school and college entrance exam scores in Taiwan using self-reported data online.   

What is the goal of this project?   

Demonstrate reproducible statistical analysis in $\mathsf{R}$ Markdown and LaTeX to PDF.    

Briefly say about the methods used  
...
\textcolor{red}{Definitely need to fix the univariate sections}   
