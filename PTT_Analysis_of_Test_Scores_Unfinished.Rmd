...
\textcolor{red}{Add a topic sentence to bring out the author's motivation}  
...
The median is 68, and the mean is about 67.6.  

Write something more, including the logistic regression prediction  

\textcolor{red}{Treat this part as an anecdote and explain my motivation.}    

Instead of dwelling on the past, the author decided to redirect her energy to something more meaningful and constructive. She would like to leverage the opportunity to apply her data science and research skills, and this is why the manuscript was born.   

Should the reproducibility statement be moved to the introduction?  
