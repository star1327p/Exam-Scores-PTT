...
The author has also been a regular contributor to the Royal Statistical Society (RSS)^[<https://rss.org.uk/>] discussion papers, in which she writes constructive feedback up to 400 words per session.   

\textcolor{red}{Elaborate more on the RSS discussion paper sessions}    

How does the written contribution get published?  

Add a few of my 400-word contributions in the References.  
