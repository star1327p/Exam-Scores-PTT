...
The graphs in this manuscript are mainly for demonstration; they are created using the basic `plot` function as the default in RStudio. For advanced data visualization, we highly encourage readers to use the $\mathsf{R}$ package `ggplot2` \cite{ggplot2}. This package provides much more capability to convey the message in a graph, and the data visualization theory behind `ggplot2` is based on *The Grammar of Graphics* \cite{wilkinson2012grammar}.      

\textcolor{red}{Consider adding books about data visualization theory, citations needed}    
