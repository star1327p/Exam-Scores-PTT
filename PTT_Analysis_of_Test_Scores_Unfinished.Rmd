...
1. Proofread the content myself (84 pages).

2. Check every single URL to make sure that it works. Some of the URLs are invalid. Beware! 

3. Also check the references in detail. For instance, the record linkage citation \cite{dusetzina2014overview} needs to be replaced or supplemented by a more recent article.
...
6. Recheck everything for the final time.

7. Publish this article to ResearchGate.
