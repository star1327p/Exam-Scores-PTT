...
We use the `R` function `table` to show the frequency of each **HighSchool_PR** at least 80. In the table below, the first row is the PR (percentile rank), and the second row is the counts. Although we truncated the **HighSchool_PR** to 80 and above, the distribution is still left-skewed. 
...
\textcolor{red}{Also create a range table of 80-89, 90-94, 95-99.}  
