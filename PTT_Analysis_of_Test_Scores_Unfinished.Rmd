...
2. Need to add more references, instead of just URLs. Especially on Taiwan's education system, which I have fewer than 10 items listed in the References. Most of my references are about statistics and/or data science itself.

3. Section \ref{College_GSAT}: Add the changes in 2022 -- GSAT contains mathematics A and mathematics B.^[<https://bit.ly/4bEoQ0y>]
...
4. Also check the references in detail. 

5. Ask some friends (preferably current high school teachers) to verify the correctness of the high school and college entrance rules in Taiwan.  

6. Ask other friends for feedback on my report.

7. Revise the report according to the feedback I receive.

8. Recheck everything one more time.

9. Obtain approval to list my new affiliation with the disclaimer.

10. Finally, publish this article to ResearchGate.
