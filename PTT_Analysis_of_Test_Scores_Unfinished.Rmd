...
In this graph from Section \ref{bivariate}, the red dot in the top-right indicates where the author's high school and college entrance exam scores stand. **HighSchool_PR** 95 and **College_Score** 69 are definitely above-average scores, despite imperfect.    
...
# UNFINISHED HERE
# No need to zoom-in for top scorers, because the separation lines show this already.
```
