...
**False positive rate** and **false negative rate** are typically used to measure the accuracy of a medical screening test for a disease \cite{diagnosis-test}, where "positive" means having the disease. In our dataset, "positive" means something much better -- getting a **College_Score** 65 or higher.  
