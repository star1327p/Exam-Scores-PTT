...
The Statistics 101 course covers the fundamental statistical concepts for students to perform data analysis, and the programming component is often included. For readers who would like a refresher, we recommend the textbook *OpenIntro Statistics* \cite{diez2019openintro} and the online course series *Statistics with `R` Specialization* on Coursera.^[<https://www.coursera.org/specializations/statistics>] Basic concepts like hypothesis testing and confidence intervals are also asked in technical interviews for data science jobs. Beware!  

\textcolor{red}{Add the Bayesian statistics material, stating that knowledge of Calculus is helpful but not required.}  

- *An Introduction to Bayesian Thinking* \cite{clyde2018bayesian101}: Textbook for the Bayesian Statistics online course on Coursera ^[<https://www.coursera.org/learn/bayesian>]          
