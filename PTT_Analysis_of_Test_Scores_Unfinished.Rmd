...
Since there are many repetitive values in **HighSchool_PR**, let's apply the `jitter` function to add noise to the data for display. We can see that the deeper black circles indicate more values in the data.
