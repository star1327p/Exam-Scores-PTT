...
Consider: Different random seeds for the partition splits.  
...
partition_list_2 = k_fold_partition(data_corr, k_fold, seed=123456)
partition_matrices_2 = k_fold_train_test(data_corr, partition_list_2, k_fold)
k_fold_table_2 = sum_up_confusion(k_fold, partition_matrices_2)
k_fold_table_2
```
...
k_fold_results_2 = confusion_to_measures(k_fold_table_2)
