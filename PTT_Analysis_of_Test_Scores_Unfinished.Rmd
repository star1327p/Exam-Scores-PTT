...
Writing on and off for the past several years.  

Green squares = GitHub commits = sense of progress^[<https://www.palomamedina.com/biceps>]    

Quote from Jodi Picoult,^[<https://www.jodipicoult.com/>] an American bestselling author:  
"You can always edit a bad page. You can't edit a blank page."^[<https://www.writingforward.com/better-writing/you-cant-edit-a-blank-page>]   

In addition to the motivations stated in the Introduction (Chapter \ref{intro}) and the Personal Scores and Remarks (Chapter \ref{personal-remarks}), the author was also inspired by ...  

[<https://jnolis.com/blog/data_science_on_book/>]  
[<https://hookedondata.org/posts/2021-04-06_publishing-a-technical-book-part-3/>]  

This project is the longest manuscript the author has independently completed after her PhD dissertation [citation needed].  

Other long-form publications she has written as a single author include NLE [citation needed] and Masters thesis [citation needed].  

The author has collaborated with others on a wide range of topics throughout the years, including Bayesian statistics [citation needed and Coursera Bayesian book], federal survey analysis [two citations needed], and other statistical applications [citations needed: LDA in 2019 and IMSM in 2015].   

Citations needed:
- Book *Build a Career in Data Science* by Emily Robinson and Jacqueline Nolis  
- My PhD dissertation  
- My Masters thesis  
- My NLE paper on text preprocessing  
- Advanced Bayesian statistics (with Jun Lu in 2022)  
- FHFA technical reports in both 2013 and 2014 (collaborative, both published in 2017)  
- Teague's LDA paper in 2019  
- IMSM 2015 technical report  
