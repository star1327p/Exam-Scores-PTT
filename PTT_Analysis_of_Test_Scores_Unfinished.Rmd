...
Given that a patient tested positive, what is the probability that he/she actually has the disease?  
...
Therefore, the patient has a 9.16% of chance of actually having the disease, despite that he/she already tested positive. The patient does not have the disease for more than 90% of the time.  

\textcolor{red}{More interpretation here}  

Since the disease infects only 0.1% of the population, the medical test creates many false positives, i.e., false alarms.  

But the test is still quite informative ??  

Given a positive test result, the probability of the patient having the disease increases to 9.16/0.1 = 91.6 times.  
