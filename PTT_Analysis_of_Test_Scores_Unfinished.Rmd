...
Try 10 different random seeds and output the results.
...
# Run train_and_test for 10 times
# output = train_and_test(data_corr, seed=123)
# output[1,1]
# output[1,2]
# output[2,1]
# output[2,2]
...
Need to write `R` functions to do so! Don't calculate by hand for all 10 matrices.  
