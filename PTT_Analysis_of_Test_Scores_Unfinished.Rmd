...
This may sound like a cliche, but I definitely learned a lot throughout the process (e.g. Git, R, reproducibility).  

Green squares = GitHub commits = sense of progress^[<https://www.palomamedina.com/biceps>]    

Quote from Jodi Picoult, an American bestselling author:^[<https://www.jodipicoult.com/>]     
...
- Book *Build a Career in Data Science* \cite{robinson2020build}     
