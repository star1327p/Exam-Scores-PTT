...
\textcolor{red}{Linking sentence from hypothesis testing to the Pearson's chi-squared test}   
...
\textcolor{red}{Explain that each $E_i$ is conditioned on row and column totals.}  
...
# Also consider: chisq.test(a, simulate.p.value = TRUE)
