...
We can create a demonstrative ROC plot using the `roc.plot` function in the `R` package `verification`.   

\textcolor{red}{Write something more in the section's foreword.}  

### Simulated Data 

We need some simulated data to make the demonstration. As a hypothetical example, the first 500 observations are 0 and the remaining 500 observations are 1. The vector array `obs_outcomes` is the actual observed binary outcomes. This array consists of elements only 0's and 1's.      
