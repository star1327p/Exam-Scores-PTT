...
In the case that p-value < 0.05, we say that the observed difference is statistically significant. However, since we do not know the underlying truth, we can make one of the two mistakes in hypothesis testing: 
