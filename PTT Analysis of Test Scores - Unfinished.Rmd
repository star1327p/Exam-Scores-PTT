...
## \textcolor{red}{Unfinished below}: Segmenting the Data
...
table(data_corr$HS_80up, data_corr$CS_60up,
      dnn=c("HighSchool_80up","College_60up"))
```

Create a percentage version of the matrix
