...
In mathematical terms, this is equivalent to finding $P(\text{College$\_$60up is true } \vert \text{ HighSchool$\_$80up is true})$. Recall the conditional probability formula:  
...
Note that we use number of respondents rather than percentage to avoid rounding errors.

# A Closer Look at the Top Scorers

Write something here  

**HighSchool_PR** threshold: 80, 90, and 95

**College_Score** thresholds: 60, 65, and 70
