...
- **False Negative (FN)**: The datapoint is actually positive, but the model **in**correctly predicts the datapoint to be negative, i.e., error.
- **False Positive (FP)**: The datapoint is actually negative, but the model **in**correctly predicts the datapoint to be positive, i.e., false alarm.
