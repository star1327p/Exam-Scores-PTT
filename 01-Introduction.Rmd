The goal of writing this manuscript is to instruct the readers on how to perform data analysis using real-life data. We focus on demonstrating the statistical methodology, so the coding implementation may not be perfectly optimized. The target audience would be people with a basic understanding of statistics, equivalent to taking or having completed Statistics 101.  

\textcolor{red}{Why did we select this dataset?}  
