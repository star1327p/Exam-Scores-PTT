...
- **CS_Inacc**: A "1" means the reported score of college entrance exam is inaccurate, otherwise the value is `NA` (missing).  
...
data$CS_Invalid = 0
data$CS_Invalid[(data$CS_Score > 99)|(data$CS_Score < 1)] = 1
