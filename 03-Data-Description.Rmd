...
- **HS_Inacc**: A "1" means the reported score of high school entrance exam is inaccurate, otherwise the value is `NA` (missing).
- **College_Inacc**: A "1" means the reported score of college entrance exam is inaccurate, otherwise the value is `NA` (missing).  

\section*{\textcolor{red}{Unfinished below}}  

The inaccuracy flag is confusing. Consider adding another set of flags: **HS_Invalid** and **College_Invalid**.  

Generate such flags with code, rather than by hand ?!  

\textcolor{red}{Inaccurate does not mean the score is invalid.}  

But should I change the missing values to zero in **HS_Inacc** and **College_Inacc**?    
